...
func World3() *HittableList { // bouncing spheres
	groundMaterial := NewLambertianFromTexture(NewCheckeredTextureFromColors(0.32, NewVec3(0.2, 0.3, 0.1), NewVec3(0.9, 0.9, 0.9)))
...
func World8() *HittableList { // purple marble
	...
	diffuseLightRed := NewColoredDiffuseLight(NewVec3Pointer(0, 0, 255))
	diffuseLightBlue := NewColoredDiffuseLight(NewVec3Pointer(255, 0, 0))
...
func World9() *HittableList { // cornell box
	...
	light := NewColoredDiffuseLight(NewVec3Pointer(7, 7, 7))
